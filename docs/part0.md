...
| 3| You understand recursion and can use it in problem solving. |
| 4| You know of the *list*, *tree* and *heap* data structures. |
| 5| You know the basics of *P=NP* problem. |
| 6| You can implement a *list*, *heap* and a *tree* data structure. |
